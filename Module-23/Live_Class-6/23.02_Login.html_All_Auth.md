...
# 🔨 How to Fix:
# Configure Google Login for Django Allauth (Cloud Console)



### 1️⃣ Go to > [Cloud Console](https://console.cloud.google.com/)
- This will require to select a gmail

### 2️⃣ Create a project
- Click on
    - Select a project → New Project → Name it → Create
...
### 4️⃣ Set up OAuth consent screen
...
### 6️⃣ Configure Django Admin panel
- Go to Django Admin panel
- Under the Social Accounts → select Social applications
- Provider: Google
