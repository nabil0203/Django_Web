# Encaptulate Method and Variable inside Class
...
#Protected members(single underscore (_)) --> accessed only within the class or its subclasses.
class Protected:
    def __init__(self):
...
# Private members(double underscore (__)) --> accessed only within the class.
class Private:
    def __init__(self):
