...
temp_list = []                                      # temporary list taken to push the elements one after one except the highest
...
print(max(temp_list))                               # print the max of the temporary list which doesn't contain the highest of the first list
