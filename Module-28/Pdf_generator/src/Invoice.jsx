//  -------------- Shorter Version with Basic Styling --------------
...
//         <Text style={{ textAlign: 'center', color: 'blue', fontWeight: 'bold' }}>Invoice</Text>
...
// -------------- Longer Version with Better Styling --------------
